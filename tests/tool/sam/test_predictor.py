...
from coc.tool.sam.g1_automagen import SAMWrapper, get_sam  # Adjust import path
from coc.tool.sam.g1_predictor import SAM2PredictorWrapper, get_sam_predictor  # Adjust import path
